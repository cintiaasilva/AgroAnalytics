...
//Função que duplica e exclui os campos da Plantação (Não está sendo utilizado)
...
//Função que duplica e exclui os campos do Talão (Não está sendo utilizado)
...
//---------------------------------------------------------------------------------------------------------
//Função que esconde os dados da coluna de menu 
function esconde(id) {
